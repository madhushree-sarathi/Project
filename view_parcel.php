...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="callout callout-info">
					<b class="border-bottom border-primary">Department</b>
					<dl>
						<dt>Name:</dt>
				...
				<div class="callout callout-info">
					<b class="border-bottom border-primary">Product</b>
					<dl>
						<dt>Name:</dt>
				...
				<div class="callout callout-info">
					...
					<dl>
						...
						<dd>
							...
							switch ($status) {
								case '1':
									echo "<span class='badge badge-pill badge-info'>Verified By Dean</span>";
									break;
								case '2':
									echo "<span class='badge badge-pill badge-info'>CSPU</span>";
									break;
								case '3':
									echo "<span class='badge badge-pill badge-primary'>Approved By Dean</span>";
									break;
								case '4':
									echo "<span class='badge badge-pill badge-primary'>Approved By Principal</span>";
									break;
								case '5':
									echo "<span class='badge badge-pill badge-primary'>Successfully Approved</span>";
									break;
								// case '6':
								...
								default:
									echo "<span class='badge badge-pill badge-info'>Request Raised</span>";
...
<div class="modal-footer display p-0 m-0">
		<!--<button class="btn btn-primary" form="view">Update</button> -->
